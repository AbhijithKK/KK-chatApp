...
const InputSection:React.FC<inputSection> = ({chatId,setMsgSnt,msgSnt}) => {
  ...
  useEffect(()=>{
    const sendMessage=async()=>{
      if (chatId && message.trim()) {
        ...
        const data=await postChatTextApi(chatId,userId,message)
  ...
  return (
    <div className='input-section-container'>
         ...
         <div className="input-box">
          <textarea onChange={(e)=>setMessage(e.target.value)} value={message} name="" id="" ></textarea>
         </div>
